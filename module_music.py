...
##  ("triumph", "triumph.mp3", mtf_sit_attack),
  ...
  ("ambushed_by_neutral", "Mind Flow.mp3", mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight),
  ("ambushed_by_khergit", "Morceaux.flac", mtf_culture_3|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("ambushed_by_nord",    "Code of Honor.mp3", mtf_culture_4|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("ambushed_by_rhodok",  "The Maneuver.mp3", mtf_culture_5|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("ambushed_by_swadian", "Ghosts Of Razgriz.flac", mtf_culture_1|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("ambushed_by_vaegir",  "Physical Layer.mp3", mtf_culture_2|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("ambushed_by_sarranid", " Avalon.flac", mtf_culture_6|mtf_sit_ambushed|mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  
  ("arena_1", "The Stage Of Apocalypse.flac", mtf_sit_arena, 0),
#  ("arena_2", "arena_2.ogg", mtf_looping|mtf_sit_arena, 0),
  ("armorer", "Flicker Of Hope.flac", mtf_sit_travel, 0),
  ("bandit_fight", "The Stage Of Apocalypse.flac", mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed, 0),
...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  ("victorious_evil", "Prove of Hero.flac", mtf_persist_until_finished, 0),
  ("victorious_neutral_1", "Prove of Hero.flac", mtf_persist_until_finished|mtf_sit_victorious, 0),
  ("victorious_neutral_2", "Prove of Hero.flac", mtf_persist_until_finished|mtf_sit_victorious, 0),
  ("victorious_neutral_3", "Prove of Hero.flac", mtf_persist_until_finished|mtf_sit_victorious, 0),

  ("victorious_swadian", "Prove of Hero.flac", mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
  ("victorious_vaegir", "Prove of Hero.flac", mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
  ("victorious_vaegir_2", "Prove of Hero.flac", mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
