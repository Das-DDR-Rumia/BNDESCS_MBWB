...
presentations = [
  #Agland
("game_credits", prsntf_read_only, 0, [
    ...
    (try_begin),
        (gt, ":map_ratio", 100),
        (assign, ":battle_map_width", 300),
        (store_div, ":battle_map_scale", ":map_width", ":battle_map_width"),
        (store_div, ":battle_map_height", ":map_height", ":battle_map_scale"),
    (else_try),
        (assign, ":battle_map_height", 300),
        (store_div, ":battle_map_scale", ":map_height", ":battle_map_height"),
        (store_div, ":battle_map_width", ":map_width", ":battle_map_scale"),
    (try_end),

    (create_mesh_overlay, reg33, "mesh_pic_prisoner_man"),#"mesh_white_plane"
    (overlay_set_color, reg33, 0),
    (store_add, ":map_bordered_width", ":battle_map_width", 20),
    (store_add, ":map_bordered_height", ":battle_map_height", 20),
    ...
    (overlay_set_alpha, reg33, 0x22),
    (troop_set_slot, "trp_temp_troop", 35, ":battle_map_scale"),#Agland:replace global variable
    (troop_set_slot, "trp_temp_troop", 36, ":battle_map_width"),
    (troop_set_slot, "trp_temp_troop", 37, ":battle_map_height"),

   
   
   
    #(call_script_translation_part, "script_update_order_panel_map"), from rubik
    # player_chest
    (try_begin),
        (scene_prop_get_instance, ":player_chest", "spr_inventory", 0),
        (ge, ":player_chest", 0),
        (create_mesh_overlay, reg34, "mesh_pic_prisoner_man"),#"mesh_white_plane"
        (overlay_set_color, reg34, 0xFF00FF),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 250),
        (overlay_set_size, reg34, pos1),
        (prop_instance_get_position, pos1, ":player_chest"),
        
        #(call_script_translation, "script_convert_3d_pos_to_map_pos"),
        (set_fixed_point_multiplier, 1000),
        (position_transform_position_to_local, pos3, pos2, pos1),
        (position_get_x, ":agent_x_pos", pos3),
        (position_get_y, ":agent_y_pos", pos3),
        (val_div, ":agent_x_pos", ":battle_map_scale"),
        (val_div, ":agent_y_pos", ":battle_map_scale"),
        (set_fixed_point_multiplier, 1000),
        (store_sub, ":map_x", 980, ":battle_map_width"),
        (store_sub, ":map_y", 730, ":battle_map_height"),
        ...
        (overlay_set_position, reg34, pos0),
    (try_end),   
    #(call_script_translation_part, "script_update_order_panel_map"), from rubik
    ...
    (ti_on_presentation_run,
     [
    (troop_get_slot, ":battle_map_scale", "trp_temp_troop", 35),#Agland:replace global variable
    (troop_get_slot, ":battle_map_width", "trp_temp_troop", 36),
    (troop_get_slot, ":battle_map_height", "trp_temp_troop", 37),
     
     
    #(call_script_translation, "script_update_order_panel_map"), from rubik
    (set_fixed_point_multiplier, 1000),
    (get_scene_boundaries, pos2, pos3),
    (try_for_agents,":cur_agent"),
        ...
        (try_begin),
            ...
            #(call_script_translation, "script_update_agent_position_on_map", ":cur_agent"),
            ...
            (try_begin),
                ...
                (try_begin),
                    ...
                    (create_mesh_overlay, reg1, "mesh_pic_prisoner_fem"),#"mesh_player_dot"
                    (position_set_x, pos1, 500),
                    (position_set_y, pos1, 500),
                    (overlay_set_size, reg1, pos1),
                (else_try),
                    (create_mesh_overlay, reg1, "mesh_pic_prisoner_wilderness"),#"mesh_white_dot"
                    (position_set_x, pos1, 200),
                    (position_set_y, pos1, 200),
                    (overlay_set_size, reg1, pos1),
                (try_end),
                (overlay_set_alpha, reg1, 0x88),
                (agent_set_slot, ":cur_agent", slot_agent_map_overlay_id, reg1),
            ...
            (try_begin),
                (eq, ":cur_agent", ":player_agent"),
                (agent_get_look_position, pos1, ":cur_agent"),
    ...
    #player_chest    #Agland:To run it only once, I moved it up
    #(call_script_translation, "script_update_order_panel_map"), from rubik
  ...
  ("troop_tree", 0, 0,[
    (ti_on_presentation_load,
      [
        ...
        (call_script, "script_troop_tree_recursive_detect_max_tier", ":troop_no", 1),
        (assign, ":max_tier", reg0),
        (val_sub, ":max_tier", 1),
        (val_max, ":max_tier", 1),
        (store_div, ":offset_x", 850, ":max_tier"),
        (val_min, ":offset_x", 150),
        
        (assign, reg2, 100),
        (call_script, "script_troop_tree_recursive_backtracking", ":troop_no", 50, reg2, ":offset_x"),
