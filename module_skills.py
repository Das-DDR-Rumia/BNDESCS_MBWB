...
skills = [
  ...
  ("first_aid", "First Aid",sf_base_att_int|sf_effects_party,10,"Heroes regain 6%% per skill level of hit-points lost during mission. (Party skill)"), 
  ...
  ("weapon_master","Weapon Master",sf_base_att_agi,10,"Makes it easier to learn weapon proficiencies and increases the proficiency limits. Limits go as: 60, 100, 140, 180, 220, 260, 300, 340, 380, 420, 460. (Personal skill)"),
