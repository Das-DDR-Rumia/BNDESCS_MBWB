    ...
    [
     ...
     ("start_test",[],"Okuu Fumo Army!",
       [
         ...
         (troop_add_item,"trp_player","itm_aya_head",0),
         (troop_add_item,"trp_player","itm_mk2rv",0),
         (troop_add_item,"trp_player","itm_ammo",0),
       ...
       [
         ...
         (troop_add_item,"trp_player","itm_okuu_warhorse",0),
         (troop_add_item,"trp_player","itm_okuu",2),
         (troop_add_item,"trp_player","itm_mk4b_kai",0),
         (troop_add_item,"trp_player","itm_ammo1",0),
         (troop_add_item,"trp_player","itm_aya_body",0),
         (troop_add_item,"trp_player","itm_aya_head",0),
         (troop_add_item,"trp_player","itm_im4",0),
         (troop_add_item,"trp_player","itm_im3",0),
         ...
         (party_add_members,"p_main_party","trp_bndescs_trained_spearman",1),
         (party_add_members,"p_main_party","trp_bndescs_veteran_spearman",1),
         (party_add_members,"p_main_party","trp_bndescs_sergeant",1),
         (party_add_members,"p_main_party","trp_bndescs_mk2rv_h",1),
         (party_add_members,"p_main_party","trp_bndescs_mk4_h",1),
         ...
         (party_add_members,"p_main_party","trp_unpaint_aya",1),
         (party_add_members,"p_main_party","trp_okuu_fumo_thrower",1),
         (party_set_bandit_attraction,"p_main_party",90),
         (troop_add_gold, "trp_player",200000),
         (troop_set_name, "trp_player", "str_okuu_test"),
         (change_screen_return),
...
##      ]),
      ...
      [
        ...
        (troop_add_item, "$g_player_troop","itm_im4",0),
