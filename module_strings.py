...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_7", "{s0} Member"),
  ...
  ("faction_title_female_7", "{s0} Member"),
  ...
  ("quick_battle_troop_1", "A normal Touhou fan, which is actually insane. He love Reiuzi Utuho very much, and made a bomb that in shape of the Okuu fumo. Now, he want to bring Okuu to everyone, in a painful way..."),
  ("quick_battle_troop_2", "A normal BNDESCS troop, which is just too normal to see."),
  ("quick_battle_troop_3", "He don't know why he is here, why his head was equipped with a strange doll head, and don't know why he's holding the bright red sword. But the only thing he know right now, is to kill anyone who want to stop him, right in his sight..."),
  ("quick_battle_troop_4", "He's a very brave and battlewise cavalry, serve for BNDESCS. The reason we don't know his name is he never say a word, no matter friendly or enemy..."),
  ("quick_battle_troop_5", "Is that so?"),
