...
game_menus = [
    ...
    [
     ...
     ("start_test",[],"Okuu Fumo Army!",
       [
         ...
         (troop_add_item,"trp_player","itm_okuu_warhorse",0),
         ...
         (troop_add_item,"trp_player","itm_aya_body",0),
         (troop_add_item,"trp_player","itm_aya_hat",0),
         (troop_add_item,"trp_player","itm_smoked_fish",0),
         (troop_add_item,"trp_player","itm_smoked_fish",0),
         (troop_add_item,"trp_player","itm_smoked_fish",0),
         (troop_add_item,"trp_player","itm_smoked_fish",0),
         ...
         (party_add_members,"p_main_party","trp_okuu_fumo_thrower",20),
         (party_set_bandit_attraction,"p_main_party",90),
         (troop_add_gold, "trp_player",200000),
         (troop_set_name, "trp_player", "str_okuu_test"),
         (change_screen_return),
       ]),
       ("start_test1",[],"Test All Troops",
       [
         (troop_set_type,"trp_player", 0),
         ...
         (troop_add_item,"trp_player","itm_aya_wing",0),
         (troop_add_item,"trp_player","itm_smoked_fish",2),
         (troop_add_item,"trp_player","itm_bride_shoes",0),
         (party_add_members,"p_main_party","trp_bndescs_0",1),
         (party_add_members,"p_main_party","trp_bndescs_spearman",1),
         (party_add_members,"p_main_party","trp_bndescs_im2",1),
         (party_add_members,"p_main_party","trp_bndescs_pipebomb",1),
         (party_add_members,"p_main_party","trp_bndescs_im3",1),
         (party_add_members,"p_main_party","trp_bndescs_trained_spearman",2),
         (party_add_members,"p_main_party","trp_bndescs_veteran_spearman",2),
         (party_add_members,"p_main_party","trp_bndescs_sergeant",2),
         (party_add_members,"p_main_party","trp_bndescs_mk2rv_h",2),
         (party_add_members,"p_main_party","trp_bndescs_mk4_h",2),
         (party_add_members,"p_main_party","trp_bndescs_mk1",1),
         (party_add_members,"p_main_party","trp_bndescs_crossbowman",1),
         (party_add_members,"p_main_party","trp_bndescs_mk2rv",1),
         (party_add_members,"p_main_party","trp_bndescs_mk2b",1),
         (party_add_members,"p_main_party","trp_bndescs_trained_crossbowman",1),
         (party_add_members,"p_main_party","trp_bndescs_veteran_crossbowman",1),
         (party_add_members,"p_main_party","trp_bndescs_sharpshooter",1),
         (party_add_members,"p_main_party","trp_bndescs_mk4b_n",1),
         (party_add_members,"p_main_party","trp_bndescs_mk4",1),
         (party_add_members,"p_main_party","trp_bndescs_mk4b",1),
         (party_add_members,"p_main_party","trp_bndescs_mk4b_kai",1),
         (party_add_members,"p_main_party","trp_bndescs_mk5",1),
         (party_add_members,"p_main_party","trp_bndescs_mk6",1),
         (party_add_members,"p_main_party","trp_bndescs_mk7",1),
         (party_add_members,"p_main_party","trp_unpaint_aya",5),
         (party_add_members,"p_main_party","trp_okuu_fumo_thrower",5),
         (party_set_bandit_attraction,"p_main_party",90),
         (troop_add_gold, "trp_player",200000),
         (troop_set_name, "trp_player", "str_okuu_test"),
         (change_screen_return),
       ]),
       ("start_test2",[],"Ayayayaya!",
       [
         (troop_set_type,"trp_player", 0),
         (assign,"$character_gender",tf_female),
         (troop_raise_attribute, "trp_player",ca_strength,1000),
         ...
         (troop_add_item,"trp_player","itm_aya_body",0),
         (troop_add_item,"trp_player","itm_aya_hat",0),
         (troop_add_item,"trp_player","itm_aya_fan",0),
         (troop_add_item,"trp_player","itm_aya_danmu",0),
         (troop_add_item,"trp_player","itm_aya_danmu",0),
         (troop_add_item,"trp_player","itm_aya_danmu",0),
         (troop_add_item,"trp_player","itm_bride_shoes",0),
         (party_add_members,"p_main_party","trp_unpaint_aya",20),
         (party_set_bandit_attraction,"p_main_party",90),
         (troop_add_gold, "trp_player",200000),
         (troop_set_name, "trp_player", "str_okuu_test"),
         (change_screen_return),
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Calradia and its kingdoms, you...",
    ...
    [],
    [
      ("test_town",[(eq, "$current_startup_quest_phase", 0),],"Test start.",
       [
...
##      ]),
      ...
      [
        ...
        (set_player_troop, "trp_player"),
        (assign, "$g_player_troop", "trp_player"),
        (troop_raise_attribute, "$g_player_troop", ca_strength, 52),
        (troop_raise_attribute, "$g_player_troop", ca_agility, 49),
        (troop_raise_attribute, "$g_player_troop", ca_charisma, 5),
        (troop_raise_skill, "$g_player_troop", skl_shield, 3),
        (troop_raise_skill, "$g_player_troop", skl_athletics, 2),
        (troop_raise_skill, "$g_player_troop", skl_riding, 3),
        ...
        (troop_raise_skill, "$g_player_troop", skl_power_draw, 5),
        (troop_raise_skill, "$g_player_troop", skl_weapon_master, 4),
        (troop_raise_skill, "$g_player_troop", skl_ironflesh, 10),
        (troop_raise_skill, "$g_player_troop", skl_horse_archery, 6),
        (troop_raise_proficiency_linear, "$g_player_troop", wpt_one_handed_weapon, 270),
        (troop_raise_proficiency_linear, "$g_player_troop", wpt_two_handed_weapon, 270),
        (troop_raise_proficiency_linear, "$g_player_troop", wpt_polearm, 270),
        (troop_raise_proficiency_linear, "$g_player_troop", wpt_crossbow, 270),
        (troop_raise_proficiency_linear, "$g_player_troop", wpt_throwing, 270),
     
        (troop_clear_inventory, "$g_player_troop"),
        (troop_add_item, "$g_player_troop","itm_aya_body",0),
        (troop_add_item, "$g_player_troop","itm_aya_hat",0),
        (troop_add_item, "$g_player_troop","itm_bride_shoes",0),
        (troop_add_item, "$g_player_troop","itm_im3",0),
        (troop_add_item, "$g_player_troop","itm_practice_sword",0),
        (troop_add_item, "$g_player_troop","itm_mk4b_kai",0),
        (troop_add_item, "$g_player_troop","itm_ammo1",0),
        (troop_add_item, "$g_player_troop","itm_aya_wing",0),
        (troop_equip_items, "$g_player_troop"),
        (set_visitor,0,"trp_player"),
        (set_visitor,32,"trp_tutorial_fighter_1"),
        (set_visitor,33,"trp_tutorial_fighter_2"),
